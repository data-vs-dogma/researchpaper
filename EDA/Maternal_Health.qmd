...
observed_anova <- aov(`maternal_mortality_rates_2018_2022_per_100,000_live births` ~ abortion_policies, data = df)
...
for (i in 1:N) {
  ...
  permuted_data <- df
  permuted_data$`maternal_mortality_rates_2018_2022_per_100,000_live births` <- sample(permuted_data$`maternal_mortality_rates_2018_2022_per_100,000_live births`)
  
  # Perform ANOVA on permuted data
  perm_anova <- aov(`maternal_mortality_rates_2018_2022_per_100,000_live births` ~ abortion_policies, data = permuted_data)
...
ggplot(df, aes(x = abortion_policies, y = percent_uninsured_women_during_pregnancy_2021, fill=abortion_policies)) +
  ...
  labs(x = "Abortion Policies", 
       y = "% Women Without Care per 100,000",
       title = "Percentage of Women who went Without Care due to Cost \nby Abortion Policy")
```
