...
```{r, message = FALSE}
df <- read_csv("../data/clean_data/merged_dataset.csv") # use if running in r studio
...
# Remove self-correlations (diagonal elements where Var1 == Var2)
correlation_df <- correlation_df %>% 
  filter(Var1 != Var2)

# Find the top 5 most positive correlations
...
# Find the top 5 most negative correlations
top_negative <- correlation_df %>%
  arrange(Freq) %>%
  head(5)

print("Top 5 Negative Correlations:")
print(top_negative %>% 
        mutate(Label = "Negative Correlation"))
