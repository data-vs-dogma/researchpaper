...
overall_avg <- mean(df$percent_women_working, na.rm = TRUE)

# Filter and classify observations as Above or Below Average
df <- df %>%
  filter(!is.na(abortion_policies) & !is.na(percent_women_working)) %>% 
  mutate(above_or_below = if_else(percent_women_working > overall_avg, 
...
=======
>>>>>>> 19db44216dc1d4b4111ba1de00ca16563971fbc1
df_count <- df_count %>%
...
ggplot(df_count, aes(x = abortion_policies, y = percentage, fill = above_or_below)) +
  ...
  labs(x = "Abortion Policies", 
       ...
       title = "Percentage of Above/Below Average Women Working by Abortion Policy") +
  theme(axis.text.x = element_text(size = 8, angle = 45, hjust = 1),
...
<<<<<<< HEAD
# Calculate the overall average
overall_avg <- mean(df$percent_women_who_received_a_postpartum_depression_screening_2021, na.rm = TRUE)
...
df <- df %>%
>>>>>>> 19db44216dc1d4b4111ba1de00ca16563971fbc1
  filter(!is.na(abortion_policies) & !is.na(percent_women_who_received_a_postpartum_depression_screening_2021)) %>% 
  mutate(above_or_below = if_else(percent_women_who_received_a_postpartum_depression_screening_2021 > overall_avg, 
                                  "Above Average", "Below Average"))
...
ggplot(df_count, aes(x = abortion_policies, y = percentage, fill = above_or_below)) +
  ...
  labs(x = "Abortion Policies", 
       y = "Percentage of Observations",
       fill = "Comparison to Average",
       title = "Percentage of Above/Below Average Postpartum Depression Screening\nby Abortion Policy") +
  theme(axis.text.x = element_text(size = 8, angle = 45, hjust = 1),
        plot.title = element_text(size = 10, hjust = 0.5),
        axis.title.y = element_text(size = 10))
...
# Calculate the overall average
overall_avg <- mean(df$percent_women_experiencing_intimate_partner_violence_2021, na.rm = TRUE)
...
df <- df %>%
>>>>>>> 19db44216dc1d4b4111ba1de00ca16563971fbc1
  filter(!is.na(abortion_policies) & !is.na(percent_women_experiencing_intimate_partner_violence_2021)) %>% 
  mutate(above_or_below = if_else(percent_women_experiencing_intimate_partner_violence_2021 > overall_avg, 
                                  "Above Average", "Below Average"))
...
>>>>>>> 19db44216dc1d4b4111ba1de00ca16563971fbc1
  labs(x = "Abortion Policies", 
       y = "Percentage of Observations",
       fill = "Comparison to Average",
       title = "Percentage of Above/Below Average Intimate Partner Violence by Abortion Policy") +
  theme(axis.text.x = element_text(size = 8, angle = 45, hjust = 1),
        plot.title = element_text(size = 10, hjust = 0.5),
        axis.title.y = element_text(size = 10))
