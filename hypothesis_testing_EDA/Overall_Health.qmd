...
# Note: alternative="decreasing" because we expect higher OBGYN ratios in more protective states
...
ggplot(df, aes(x = abortion_policies, y = health_care_quality_and_prevention, fill = abortion_policies)) +
  ...
  scale_fill_manual(values = c("#1c7416", "#68bb59", "#acdf87", "#fab733", "#ff6242", "#ff0000", "#c61a09")) +
  labs(
    title = "Boxplot for Health Care Quality and Prevention by Abortion Policies",
    x = "Abortion Policies",
...
ggplot(df, aes(x = abortion_policies, y = health_outcomes, fill = abortion_policies)) +
  ...
  scale_fill_manual(values = c("#1c7416", "#68bb59", "#acdf87", "#fab733", "#ff6242", "#ff0000", "#c61a09")) +
  labs(
    title = "Boxplot for Health Outcomes by Abortion Policies",
    x = "Abortion Policies",
    y = "Health Outcomes",
    fill = "Abortion Policies"
  ) +
